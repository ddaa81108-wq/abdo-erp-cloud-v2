    ...
    <div className="space-y-4 text-right" dir="rtl">
      ...
      {selectedCustomerId && selectedAccDetails && (
        <div className="fixed inset-0 bg-slate-950/50 backdrop-blur-xs z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl p-6 shadow-2xl max-w-5xl w-full border border-slate-200 flex flex-col max-h-[90vh] text-right">
            ...
            <div className="flex items-center justify-between gap-4 flex-wrap border-b pb-4 mb-4">
              <div className="flex items-center gap-3">
                ...
                {selectedAccDetails.debtBalance > 0 && (
                  <span className="bg-rose-100 text-rose-700 text-[11px] font-bold px-3 py-1 rounded-full">مدين</span>
                )}
                {selectedAccDetails.debtBalance < 0 && (
                  <span className="bg-emerald-100 text-emerald-700 text-[11px] font-bold px-3 py-1 rounded-full">أمانة</span>
                )}
                {selectedAccDetails.debtBalance === 0 && (
                  <span className="bg-slate-100 text-slate-600 text-[11px] font-bold px-3 py-1 rounded-full">مسدد</span>
                )}
              </div>
              ...
              <div className="flex items-center gap-2 flex-wrap">
                <button
                  ...
                  className="bg-indigo-50 hover:bg-indigo-100 text-indigo-700 border border-indigo-200 font-bold text-xs px-3 py-2 rounded-lg transition flex items-center gap-1"
                >
                ...
                <button
                  ...
                  className={`bg-emerald-600 hover:bg-emerald-700 text-white font-extrabold text-xs px-3 py-2 rounded-lg shadow transition flex items-center gap-1 ${selectedAccDetails.debtBalance <= 0 ? "opacity-50 cursor-not-allowed" : ""}`}
                >
                ...
                <button
                  ...
                  className="bg-indigo-50 hover:bg-indigo-100 text-indigo-700 border border-indigo-200 font-extrabold text-xs px-3 py-2 rounded-lg transition flex items-center gap-1"
                >
                ...
                <button
                  ...
                  className="bg-rose-50 hover:bg-rose-100 text-rose-700 border border-rose-200 font-extrabold text-xs px-3 py-2 rounded-lg transition flex items-center gap-1"
                >
                  <Plus className="w-3.5 h-3.5" />
                  إضافة دين
                </button>
            ...
            {/* الجدول */}
            <div className="flex-1 overflow-y-auto border border-slate-200 rounded-xl p-4 bg-slate-50/50 mb-4 min-h-[180px]">
                  ...
                  <table className="w-full text-sm border-collapse">
                    <thead>
                      <tr className="bg-slate-100 text-slate-700 font-bold border-b-2 border-slate-300">
                        ...
                        <th className="p-2 text-right">إجمالي الديون</th>
                        ...
                        return sortedTxs.map((tx) => {
                          ...
                          return (
                            <tr key={tx.id} className="hover:bg-slate-50 transition-colors">
                              <td className="p-2 text-right font-mono">{sequence++}</td>
                              <td className="p-2 font-sans text-[11px]">{dateStr}</td>
